  ...
  <main class="flex-1 xl:ml-64 mb-6 flex-col flex gap-6 p-6">
      ...
      <div class="max-w-3xl flex flex-col gap-6">
          ...
          <div class="border-b border-zinc-200 dark:border-zinc-800">
              <nav class="flex gap-6 overflow-x-auto">
                  ...
                  <button data-tab="account"
                      class="settings-tab active pb-3 text-sm font-medium border-b-2 border-black dark:border-white">
                      Profile
                  </button>

                  <button data-tab="appearance"
                      class="settings-tab pb-3 text-sm text-zinc-500">
                      Appearance
                  </button>
          ...
          <section id="account" class="tab-content ">
              ...
              <div class="flex gap-2 flex-col">
                  <h2 class="text-sm font-semibold text-zinc-400">Account</h2>
      ...
      <div id="appearance" class=" tab-content hidden flex gap-2 flex-col">
      ...
      <div id="notifications" class=" tab-content hidden flex gap-2 flex-col">
      ...
      <section id="security"
          class="tab-content hidden flex gap-2 flex-col">
